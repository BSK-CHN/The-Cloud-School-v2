...
//#region node_modules/.nitro/vite/services/ssr/assets/email-pwtdYqxW.js
var resend = new Resend(getServerEnv().resendApiKey);
var FROM = getServerEnv().resendFrom;
...
*/
async function notifyConsultation(input) {
...
async function notifyWorkshop(input) {
...
//#endregion
export { notifyWorkshop as n, notifyConsultation as t };
