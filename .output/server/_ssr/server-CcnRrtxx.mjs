...
import { n as getResponse, r as requestHandler } from "./request-response-Cjsdkqjy.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BCg0uPVb.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CgqWUJ1F.mjs"),
		import("./start-D_f_B7RS.mjs"),
